...
#load model data
adalasso500.data <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/adalasso_500.RData")
...
adalasso.mse.bias.HALF <- combined.data[c(1,2)] %>%   
  map(safely(msebias.adalasso))

saveRDS(adalasso.mse.bias.HALF , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/mse_bias/msebias_adalasso_500.RData")
