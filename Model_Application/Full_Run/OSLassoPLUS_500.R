...
OSlassoPLUS.half <- half.data %>%   
        map(safely(OSlassoPLUS.sim.fnct))

saveRDS(OSlassoPLUS.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/OSlassoPLUS_500.RData")
