...
msaelnet5.HD.debug <- HD.data_DEBUG %>%   
       map(safely(msaelnet5.sim.fnct))

saveRDS(msaelnet5.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet5_HD_DEBUG.RData")
