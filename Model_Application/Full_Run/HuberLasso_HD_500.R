...
HuberLasso.HD.half <- HD.data %>%   
        map(safely(H.lasso.sim.fnct))

saveRDS(HuberLasso.HD.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/HuberLasso_HD_500.RData")
