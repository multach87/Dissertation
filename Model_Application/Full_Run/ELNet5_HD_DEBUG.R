...
elnet5.HD.debug <- HD.data_DEBUG %>%   
       map(safely(elnet5.sim.fnct))

saveRDS(elnet5.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/elnet5_HD_DEBUG.RData")
