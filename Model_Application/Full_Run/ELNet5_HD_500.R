...
elnet5.HD.HALF <- HD.halfdata %>%   
       map(safely(elnet5.sim.fnct))

saveRDS(elnet5.HD.HALF , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/elnet5_HD_500.RData")
