...
SNCDLAD.elnet5.sim.fnct <- function(data) { 
  ...
  return(list(#full = list(everything = LADelnet5.nu.cv.full , 
    #            nu.cv.lambda = LADelnet5.nu.cv.lambda ,
    #            nu.cv.mse = LADelnet5.nu.cv.mse ,
    #            nu.cv.msesd = LADelnet5.nu.cv.msesd , 
    #            nu.cv.coefs = LADelnet5.nu.cv.coefs) ,
...
LADelnet5.HD <- HD.data %>%   
  map(safely(SNCDLAD.elnet5.sim.fnct))

saveRDS(LADelnet5.HD , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/SNCDLADelnet5_HD_500.RData")
