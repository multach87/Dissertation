...
adaelnet9.sim.fnct <- function(data) { 
...
adaelnet9.HD.debug <- HD.data_DEBUG %>%   
       map(safely(adaelnet9.sim.fnct))

saveRDS(adaelnet9.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/adaelnet9_HD_DEBUG.RData")
