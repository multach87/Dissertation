...
msaelnet5.HD.HALF <- HD.halfdata %>%   
       map(safely(msaelnet5.sim.fnct))

saveRDS(msaelnet5.HD.HALF , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet5_HD_500.RData")
