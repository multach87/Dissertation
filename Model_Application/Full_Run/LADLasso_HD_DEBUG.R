...
ladlasso.HD.debug <- HD.data_DEBUG %>%   
       map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_DEBUG.RData")
