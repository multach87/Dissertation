...
OSLassoPLUS.HD.HALF <- HD.halfdata %>%   
        map(safely(OSlassoPLUS.sim.fnct))

saveRDS(OSLassoPLUS.HD.HALF , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/OSlassoPLUS_HD_500.RData")
