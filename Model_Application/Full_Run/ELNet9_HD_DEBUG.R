...
elnet9.sim.fnct <- function(data) { 
       ...
       return(list(model = list(full.modelw32 = elnet9.model , 
...
elnet9.HD.debug <- HD.data_DEBUG %>%   
       map(safely(elnet9.sim.fnct))

saveRDS(elnet9.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/elnet9_HD_DEBUG.RData")
