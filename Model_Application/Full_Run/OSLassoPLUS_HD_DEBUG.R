...
OSLassoPLUS.HD.debug <- HD.data_DEBUG %>%   
        map(safely(OSlassoPLUS.sim.fnct))

saveRDS(OSLassoPLUS.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/OSlassoPLUS_HD_DEBUG.RData")
