...
ladlasso.full <- full.data %>%   
       map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.full , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_full.RData")
...
##                                   condition = as.data.frame(unlist(full.data[[i]]$condition) , 
##                                                             n = n , p = p , 
