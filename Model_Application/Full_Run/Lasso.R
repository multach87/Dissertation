...
lasso.full <- full.data %>%   
       map(safely(lasso.sim.fnct))

saveRDS(lasso.full , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/lasso_full.RData")
