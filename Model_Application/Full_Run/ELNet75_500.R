...
#function
elnet75.sim.fnct <- function(data , alpha = 0.75) {
...
elnet75.half <- half.data %>%   
  map(safely(elnet75.sim.fnct))

saveRDS(elnet75.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/elnet75_500.RData")
