...
elnet75.HD.debug <- HD.data_DEBUG %>%   
       map(safely(elnet75.sim.fnct))

saveRDS(elnet75.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/elnet75_HD_DEBUG.RData")
