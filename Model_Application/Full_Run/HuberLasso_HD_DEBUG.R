...
HuberLasso.HD.debug <- HD.data_DEBUG %>%   
        map(safely(H.lasso.sim.fnct))

saveRDS(HuberLasso.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/HuberLasso_HD_DEBUG.RData")
