...
distr100.halfdata <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/distr100.RData")
...
msaelnet75.distr100.half <- distr100.halfdata %>%   
       map(safely(msaelnet75.sim.fnct))

saveRDS(msaelnet75.distr100.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet75_distr100_500.RData")
