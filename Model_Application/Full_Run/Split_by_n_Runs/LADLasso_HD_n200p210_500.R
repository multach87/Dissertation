...
ladlasso.HD.n200p210 <- HD.n200p210 %>%   
       map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.n200p210 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_n200p210_500.RData")
