...
ladlasso.HD.ex2ey0 <- HD.ex2ey0 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.ex2ey0 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_ex2ey0_500.RData")
