...
#load data
HD.g0h2 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_g0h2.RData")
...
ladlasso.HD.g0h2 <- HD.g0h2 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.g0h2 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_g0h2_500.RData")
