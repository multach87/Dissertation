...
outlier100.halfdata <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/outlier100.RData")
...
msaelnet75.outlier100.half <- outlier100.halfdata %>%   
       map(safely(msaelnet75.sim.fnct))

saveRDS(msaelnet75.outlier100.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet75_outlier100_500.RData")
