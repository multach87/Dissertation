...
HD1000g0h2.data <- HD.data[7001:7500]
rm(list = c("HD.data"))
...
pense5.HD1000g0h2 <- HD1000g0h2.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.HD1000g0h2 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_HD1000g0h2_500.RData")
