...
#load data
HD.g2h2 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_g2h2.RData")
...
ladlasso.HD.g2h2 <- HD.g2h2 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.g2h2 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_g2h2_500.RData")
