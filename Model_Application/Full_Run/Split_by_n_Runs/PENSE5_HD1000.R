...
pense5.HD1000 <- HD1000.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.HD1000 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_HD1000_500.RData")
