...
#load data
HD.n200p500 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_n200p500.RData")
...
ladlasso.HD.n200p500 <- HD.n200p500 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.n200p500 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_n200p500_500.RData")
