...
msaelnet5.outlier100.half <- outlier100.halfdata %>%   
       map(safely(msaelnet5.sim.fnct))

saveRDS(msaelnet5.outlier100.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet5_outlier100_500.RData")
