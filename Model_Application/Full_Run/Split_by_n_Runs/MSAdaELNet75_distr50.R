...
msaelnet75.distr50.half <- distr50.halfdata %>%   
       map(safely(msaelnet75.sim.fnct))

saveRDS(msaelnet75.distr50.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet75_distr50_500.RData")
