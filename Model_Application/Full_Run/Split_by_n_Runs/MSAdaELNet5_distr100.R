...
msaelnet5.distr100.half <- distr100.halfdata %>%   
       map(safely(msaelnet5.sim.fnct))

saveRDS(msaelnet5.distr100.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet5_distr100_500.RData")
