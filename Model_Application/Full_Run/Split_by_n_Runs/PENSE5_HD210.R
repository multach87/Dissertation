...
pense5.HD210 <- HD210.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.HD210 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_HD210_500.RData")
