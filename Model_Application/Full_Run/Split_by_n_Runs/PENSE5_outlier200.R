...
pense5.outlier200 <- outlier200.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.outlier200 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_outlier200.RData")
