...
#load data
HD.ex1ey0 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_ex1ey0.RData")
...
ladlasso.HD.ex1ey0 <- HD.ex1ey0 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.ex1ey0 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_ex1ey0_500.RData")
