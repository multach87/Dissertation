...
distr200.halfdata <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/distr200.RData")
...
msaelnet75.distr200.half <- distr200.halfdata %>%   
       map(safely(msaelnet75.sim.fnct))

saveRDS(msaelnet75.distr200.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet75_distr200_500.RData")
