...
outlier25.halfdata <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/outlier25.RData")
...
msaelnet75.outlier25.half <- outlier25.halfdata %>%   
       map(safely(msaelnet75.sim.fnct))

saveRDS(msaelnet75.outlier25.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet75_outlier25_500.RData")
