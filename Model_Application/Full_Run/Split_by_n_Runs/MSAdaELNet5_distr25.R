...
msaelnet5.distr25.half <- distr25.halfdata %>%   
       map(safely(msaelnet5.sim.fnct))

saveRDS(msaelnet5.distr25.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet5_distr25_500.RData")
