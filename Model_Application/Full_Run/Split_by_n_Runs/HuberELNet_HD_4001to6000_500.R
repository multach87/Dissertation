...
huberelnet5.HD <- HD.data %>%   
  map(safely(SNCDHuber.elnet5.sim.fnct))

saveRDS(huberelnet5.HD , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/Huberelnet5_HD_4001to6000_500_COEFS.RData")
