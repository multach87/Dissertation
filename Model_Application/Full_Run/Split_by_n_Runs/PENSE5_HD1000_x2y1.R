...
HD1000x2y1.data <- HD.data[4501:5000]
rm(list = c("HD.data"))
...
pense5.HD1000x2y1 <- HD1000x2y1.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.HD1000x2y1 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_HD1000x2y1_500.RData")
