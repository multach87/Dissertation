...
HD1000x1y2.data <- HD.data[5501:6000]
rm(list = c("HD.data"))
...
pense5.HD1000x1y2 <- HD1000x1y2.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.HD1000x1y2 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_HD1000x1y2_500.RData")
