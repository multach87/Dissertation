...
HD1000x2y0.data <- HD.data[3001:3500]
rm(list = c("HD.data"))
...
pense5.HD1000x2y0 <- HD1000x2y0.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.HD1000x2y0 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_HD1000x2y0_500.RData")
