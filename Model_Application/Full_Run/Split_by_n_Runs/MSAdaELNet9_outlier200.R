...
msaelnet9.outlier200.half <- outlier200.halfdata %>%   
       map(safely(msaelnet9.sim.fnct))

saveRDS(msaelnet9.outlier200.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet9_outlier200_500.RData")
