...
ladlasso.HD.n200p1000 <- HD.n200p1000 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.n200p1000 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_n200p1000_500.RData")
