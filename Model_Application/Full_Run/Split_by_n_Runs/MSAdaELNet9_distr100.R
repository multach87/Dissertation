...
msaelnet9.distr100.half <- distr100.halfdata %>%   
       map(safely(msaelnet9.sim.fnct))

saveRDS(msaelnet9.distr100.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet9_distr100_500.RData")
