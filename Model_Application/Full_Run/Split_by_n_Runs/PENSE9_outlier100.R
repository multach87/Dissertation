...
pense9.sim.fnct <- function(data) {
  ...
  pense.cv <- pense_cv(x = X , y = Y , alpha = 0.9 , 
...
pense9.outlier100 <- outlier100.data %>%   
  map(safely(pense9.sim.fnct))

saveRDS(pense9.outlier100 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense9_outlier100.RData")
