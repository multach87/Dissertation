...
#load data
HD.ex2ey1 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_ex2ey1.RData")
...
ladlasso.HD.ex2ey1 <- HD.ex2ey1 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.ex2ey1 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_ex2ey1_500.RData")
