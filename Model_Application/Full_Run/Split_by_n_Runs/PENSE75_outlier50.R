...
pense75.outlier50 <- outlier50.data %>%   
  map(safely(pense75.sim.fnct))

saveRDS(pense75.outlier50 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense75_outlier50.RData")
