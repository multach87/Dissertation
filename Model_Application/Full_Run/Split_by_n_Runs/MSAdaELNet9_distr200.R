...
msaelnet9.distr200.half <- distr200.halfdata %>%   
       map(safely(msaelnet9.sim.fnct))

saveRDS(msaelnet9.distr200.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet9_distr200_500.RData")
