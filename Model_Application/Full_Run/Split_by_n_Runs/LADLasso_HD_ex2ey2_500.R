...
#load data
HD.ex2ey2 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_ex2ey2.RData")
...
ladlasso.HD.ex2ey2 <- HD.ex2ey2 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.ex2ey2 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_ex2ey2_500.RData")
