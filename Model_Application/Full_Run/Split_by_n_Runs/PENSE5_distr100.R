...
pense5.distr100 <- distr100.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.distr100 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_distr100.RData")
