...
#load data
HD.ex1ey1 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_ex1ey1.RData")
...
ladlasso.HD.ex1ey1 <- HD.ex1ey1 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.ex1ey1 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_ex1ey1_500.RData")
