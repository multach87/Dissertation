...
HD1000x1y0.data <- HD.data[2501:3000]
rm(list = c("HD.data"))
...
pense5.HD1000x1y0 <- HD1000x1y0.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.HD1000x1y0 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_HD1000x1y0_500.RData")
