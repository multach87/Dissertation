...
#load data
HD.ex0ey1 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_ex0ey1.RData")
...
ladlasso.HD.ex0ey1 <- HD.ex0ey1 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.ex0ey1 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_ex0ey1_500.RData")
