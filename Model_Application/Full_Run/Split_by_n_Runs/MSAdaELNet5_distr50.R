...
msaelnet5.distr50.half <- distr50.halfdata %>%   
       map(safely(msaelnet5.sim.fnct))

saveRDS(msaelnet5.distr50.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet5_distr50_500.RData")
