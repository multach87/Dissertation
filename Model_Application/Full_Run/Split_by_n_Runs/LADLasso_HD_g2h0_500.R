...
#load data
HD.g2h0 <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/HD_g2h0.RData")
...
ladlasso.HD.g2h0 <- HD.g2h0 %>%   
  map(safely(ladlasso.sim.fnct))

saveRDS(ladlasso.HD.g2h0 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/ladlasso_HD_g2h0_500.RData")
