...
#function
pense75.sim.fnct <- function(data) {
  ...
  pense.cv <- pense_cv(x = X , y = Y , alpha = 0.75 , 
...
pense75.outlier200 <- outlier200.data %>%   
  map(safely(pense75.sim.fnct))

saveRDS(pense75.outlier200 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense75_outlier200.RData")
