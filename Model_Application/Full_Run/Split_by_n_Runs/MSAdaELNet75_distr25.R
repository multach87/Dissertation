...
distr25.halfdata <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/distr25.RData")
...
msaelnet75.distr25.half <- distr25.halfdata %>%   
       map(safely(msaelnet75.sim.fnct))

saveRDS(msaelnet75.distr25.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet75_distr25_500.RData")
