...
pense5.outlier100 <- outlier100.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.outlier100 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_outlier100.RData")
