...
pense5.outlier50 <- outlier50.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.outlier50 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_outlier50.RData")
