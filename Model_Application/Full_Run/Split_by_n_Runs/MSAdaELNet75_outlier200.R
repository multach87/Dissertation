...
outlier200.halfdata <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/outlier200.RData")
...
msaelnet75.outlier200.half <- outlier200.halfdata %>%   
       map(safely(msaelnet75.sim.fnct))

saveRDS(msaelnet75.outlier200.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet75_outlier200_500.RData")
