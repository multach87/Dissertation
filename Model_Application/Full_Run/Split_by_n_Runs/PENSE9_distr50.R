...
pense9.distr50 <- distr50.data %>%   
  map(safely(pense9.sim.fnct))

saveRDS(pense9.distr50 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense9_distr50.RData")
