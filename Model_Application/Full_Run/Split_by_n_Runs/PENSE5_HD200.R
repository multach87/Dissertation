...
pense5.HD200 <- HD200.data %>%   
  map(safely(pense5.sim.fnct))

saveRDS(pense5.HD200 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense5_HD200_500.RData")
