...
pense75.distr200 <- distr200.data %>%   
  map(safely(pense75.sim.fnct))

saveRDS(pense75.distr200 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense75_distr200.RData")
