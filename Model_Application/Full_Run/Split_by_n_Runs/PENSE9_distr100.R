...
pense9.distr100 <- distr100.data %>%   
  map(safely(pense9.sim.fnct))

saveRDS(pense9.distr100 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/pense9_distr100.RData")
