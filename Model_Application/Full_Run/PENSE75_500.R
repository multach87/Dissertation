...
#function
pense75.sim.fnct <- function(data , alpha = 0.75) {
  ...
  #set seed
  seed.pensecv <- data$seeds[ , "seed.12"]
...
pense75.half <- half.data %>%   
  map(safely(pense75.sim.fnct))

saveRDS(pense75.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/pense75_500.RData")
