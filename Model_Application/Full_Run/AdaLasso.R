...
#run across full dataset
adalasso.full <- full.data %>%   
       map(safely(adalasso.sim.fnct))

saveRDS(adalasso.full , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/adalasso_full.RData")
