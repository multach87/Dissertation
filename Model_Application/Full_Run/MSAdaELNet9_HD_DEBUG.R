...
msaelnet9.HD.debug <- HD.data_DEBUG %>%   
       map(safely(msaelnet9.sim.fnct))

saveRDS(msaelnet9.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet9_HD_DEBUG.RData")
