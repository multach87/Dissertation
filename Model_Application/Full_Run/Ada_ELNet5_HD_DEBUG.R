...
adaelnet5.HD.debug <- HD.data_DEBUG %>%   
       map(safely(adaelnet5.sim.fnct))

saveRDS(adaelnet5.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/adaelnet5_HD_DEBUG.RData")
