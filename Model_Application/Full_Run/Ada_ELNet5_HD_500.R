...
adaelnet5.HD.HALF <- HD.halfdata %>%   
       map(safely(adaelnet5.sim.fnct))

saveRDS(adaelnet5.HD.HALF , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/adaelnet5_HD_500.RData")
