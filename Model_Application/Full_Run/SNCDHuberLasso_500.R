...
huberlasso.HALF <- HALF.data %>%   
  map(safely(SNCDHuber.lasso.sim.fnct))

saveRDS(huberlasso.HALF , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/SNCDHuberLasso_500_COEFS.RData")
