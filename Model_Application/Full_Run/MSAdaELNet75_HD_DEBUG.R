...
msaelnet75.HD.debug <- HD.data_DEBUG %>%   
       map(safely(msaelnet75.sim.fnct))

saveRDS(msaelnet75.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Split_by_n/msaelnet75_HD_DEBUG.RData")
