...
OSHuberLasso.HD.debug <- HD.data_DEBUG %>%   
        map(safely(OSHlasso.sim.fnct))

saveRDS(OSHuberLasso.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/OSHuberLasso_HD_DEBUG.RData")
