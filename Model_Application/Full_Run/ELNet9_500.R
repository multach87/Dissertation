...
#function
elnet9.sim.fnct <- function(data , alpha = 0.9) {
...
elnet9.half <- half.data %>%   
  map(safely(elnet9.sim.fnct))

saveRDS(elnet9.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/elnet9_500.RData")
