...
single.test <- adaelnet5.sim.fnct(single.data)


#run across debug dataset
#adaelnet5.debug <- debug.data %>%   
#       map(safely(adaelnet5.sim.fnct))

#saveRDS(adaelnet5.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Error_Storage/std_adaelnet5_DEBUG.RData")
