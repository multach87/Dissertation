...
msaelnet5.model2 <- msaelnet5.sim.fnct(testing10.data[[1]])
msaelnet75.model2 <- msaelnet75.sim.fnct(testing10.data[[1]])
msaelnet9.model2 <- msaelnet9.sim.fnct(testing10.data[[1]])


#run across debug dataset
msaelnet5.testing10 <- testing10.data %>%   
       map(safely(msaelnet5.sim.fnct))
msaelnet75.testing10 <- testing10.data %>%   
        map(safely(msaelnet75.sim.fnct))
msaelnet9.testing10 <- testing10.data %>%   
