...
elnet5.testing10 <- testing10.data %>%   
       map(safely(elnet5.sim.fnct))

saveRDS(elnet5.half , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/elnet5_testing10.RData")
