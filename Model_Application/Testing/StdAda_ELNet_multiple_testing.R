...
adaelnet5.sim.fnct <- function(data , alpha = 0.5) { 
...
#run across testing10 dataset
adaelnet5.testing10 <- testing10.data %>%   
       map(safely(adaelnet5.sim.fnct))

#saveRDS(adaelnet5.testing10 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Error_Storage/std_adaelnet5_testing10.RData")
