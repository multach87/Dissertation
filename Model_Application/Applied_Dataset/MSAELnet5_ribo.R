...
msadaelnet5.full <- ribo[1:2] %>%   
       map(safely(msadaelnet5.sim.fnct))

saveRDS(msadaelnet5.full , "/Users/Matt/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Applied_Storage/msadaelnet5_ribo.RData")
