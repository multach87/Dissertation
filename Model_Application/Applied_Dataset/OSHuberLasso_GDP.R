...
oshuberlasso.full <- GDP %>%   
       map(safely(oshuberlasso.sim.fnct))

saveRDS(oshuberlasso.full , "/Users/Matt/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Applied_Storage/oshuberlasso_GDP.RData")
