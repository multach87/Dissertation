...
huberelnet5.sim.fnct <- function(data) {
       ...
       ##initialize full list of huber elnet5 results from each nu/gamma
...
huberelnet5.full <- ribo[1:2] %>%   
       map(safely(huberelnet5.sim.fnct))

saveRDS(huberelnet5.full , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Applied_Storage/SNCDhuberelnet5_ribo.RData")
