...
adaelnet75.sim.fnct <- function(data , alpha = 0.75) { 
       ...
       seed.pre.nu <- data$seeds[ , "seed.17"]
...
adaelnet75.debug <- debug.data %>%   
       map(safely(adaelnet75.sim.fnct))

saveRDS(adaelnet75.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Error_Storage/std_adaelnet75_DEBUG.RData")
