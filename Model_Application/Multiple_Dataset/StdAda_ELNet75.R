...
adaelnet75.testing10 <- testing10.data %>%   
       map(safely(adaelnet75.sim.fnct))

saveRDS(adaelnet75.testing10 , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Error_Storage/std_adaelnet75_TESTING10.RData")
