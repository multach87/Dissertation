...
#load data
HD_DEBUG.data <- readRDS("/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/HD_debug_data_11302020.RData")
...
huberlasso.HD.debug <- HD_DEBUG.data %>%   
  map(safely(SNCDHuber.lasso.sim.fnct))

saveRDS(huberlasso.HD.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/SNCDHuberLasso_HD_DEBUG.RData")
