...
huberelnet5.debug <- DEBUG.data %>%   
  map(safely(SNCDHuber.elnet5.sim.fnct))

saveRDS(huberelnet5.debug , "/Users/Matt Multach/Dropbox/USC_Grad2/Courses/Dissertation/Dissertation_Git/Data_Storage/Full_results/Huberelnet5_DEBUG.RData")
